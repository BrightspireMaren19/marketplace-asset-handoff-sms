...
> Design notes for **marketplace-asset-handoff-sms** — a runnable typescript example that Typed Node service that sends buyer SMS updates and observes delivery during seller asset handoff.
...
- **Feature code** — the actual task: marketplace-asset-handoff.
